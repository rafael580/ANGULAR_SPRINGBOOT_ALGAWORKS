package com.example.fullapimoney.controller.exception;

import com.example.fullapimoney.service.exception.ControllerExceptionNotExist;
...
public class ControllerExceptionHandler {
    ...
    // execao pega do spring e tratada
    @ExceptionHandler(EmptyResultDataAccessException.class)
    public ResponseEntity<StandardError> ResultadoVazio(EmptyResultDataAccessException e , HttpServletRequest request){
        HttpStatus status = HttpStatus.NOT_FOUND;
        StandardError err = new StandardError();
        err.setTimestamp(Instant.now());
        err.setStatus(status.value());
